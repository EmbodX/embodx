...
export function closure16230_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h237ddd4e1ec4c299(a: number, b: number): void;
export function closure79142_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1cf92a970c0a0b7a(a: number, b: number): void;
export function closure80324_externref_shim(a: number, b: number, c: number): void;
export function closure80325_externref_shim(a: number, b: number, c: number, d: number): void;
